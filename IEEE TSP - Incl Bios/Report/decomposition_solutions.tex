...
\end{multline}}
where \me{\zeta_{l,k,n,b}} is the total interference caused by the transmission of \ac{BS} \me{b} to user \me{k \in \mc{U}_{b_k}} in spatial stream \me{l} and sub-channel \me{n}. In order to ensure \eqref{eqn-9.1c}, we impose
...
{\zeta}_{1,\mc{U}_{b_k}(1),1,b},\dotsc, {\zeta}_{L,\mc{U}_{b_k}(|\mc{U}_{b_k}|),N,b} ].
\end{multline}

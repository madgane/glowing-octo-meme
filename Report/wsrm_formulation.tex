...
Now, the optimal linear receivers for the fixed transmit precoders \me{\mbf{M}_{i,n} \, \forall i \in \mc{U}, \, \forall n \in \mc{C}} are obtained by minimizing \eqref{eqn-3} w.r.t \me{\mbf{w}_{l,k,n}} as

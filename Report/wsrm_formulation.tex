...
Now, the optimal linear receiver for the fixed transmit precoders \me{\mbf{M}_{i,n} \, \forall i \in \mc{U}, \, \forall n \in \mc{C}} is obtained by minimizing \eqref{eqn-3} w.r.t \me{\mbf{w}_{l,k,n}}, which is given by
...
\end{IEEEeqnarray}
Now, by solving for the optimal receiver using \ac{KKT} conditions, we obtian the following expression for the receive beamformer \me{\mvec{w}{l,k,n}} in an iterative manner as
...
\mvec{w}{l,k,n}^{(i)} &=& \left ( \frac{\tilde{\beta}_{l,k,n} {\mbf{m}}_{l,k,n}^\herm \mvec{H}{b_k,k,n}^\herm \mbf{w}_{l,k,n}^{(i-1)} }{\|\mvec{w}{l,k,n}^{(i-1)} \mvec{H}{b_k,k,n} {\mbf{m}}_{l,k,n} \|^2} \right ) \, \mvec{R}{l,k,n}^{-1} \, \mvec{H}{b_k,k,n} {\mbf{m}}_{l,k,n}
\end{subeqnarray}
where \me{\mvec{w}{l,k,n}^{(i-1)}} denotes the receive beamformer found in the earlier iteration, around which the linear relaxation is performed to convexify the problem in \eqref{eqn-9--1}. It can be seen that the optimal receiver expression in \eqref{opt-rx} is the scaled version of the \ac{MMSE} receiver, which is given by

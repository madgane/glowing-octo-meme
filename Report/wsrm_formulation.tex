...
We now present an iterative algorithm to solve problem \eqref{eqn-3} by using alternating optimization technique in conjunction with \acf{SCA} \cite{marks1978technical}. To do this, first by using the \ac{SINR} expression in \eqref{eq:SINR}, we equivalently reformulate problem \eqref{eqn-3} as

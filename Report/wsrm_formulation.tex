...
\end{IEEEeqnarray}
Now, solving for the optimal receiver using \ac{KKT} conditions, we obtian the following expression in an iterative manner around the \ac{SCA} point \me{\mbf{\tilde{w}}_{l,k,n}}
...
\mvec{w}{l,k,n} &=& \left ( \frac{\tilde{\beta}_{l,k,n} {\mbf{m}}_{l,k,n}^\herm \mvec{H}{b_k,k,n}^\herm \tilde{\mbf{w}}_{l,k,n} }{\|\tilde{\mbf{w}}_{l,k,n} \mvec{H}{b_k,k,n} {\mbf{m}}_{l,k,n} \|^2} \right ) \, \mvec{R}{l,k,n}^{-1} \, \mvec{H}{b_k,k,n} {\mbf{m}}_{l,k,n}
\end{subeqnarray}
where the fractional term inside the brace is a constant. It can be seen that the optimal receiver expression in \eqref{opt-rx} is the scaled version of the \ac{MMSE} receiver, which is given by

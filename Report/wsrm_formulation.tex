...
In order to prove the convergence of the proposed iterative algorithm, we require the following conditions to be satisfied at each \ac{SCA} iteration \cite{scutari}
\begin{itemize}

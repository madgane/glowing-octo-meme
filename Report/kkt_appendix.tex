...
To design the transmit precoders iteratively, we solve the \ac{KKT} conditions of problem \eqref{kkt-mse-1} by assuming \eqref{kkt-mse-1.2} and \eqref{kkt-mse-1.3} hold with equality. Hence, we obtain the following equations.

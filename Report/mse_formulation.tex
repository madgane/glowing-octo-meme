...
\end{IEEEeqnarray}
where \eqref{eqn-mse-1.3} bounds the \ac{MSE} by \me{\epsilon_{l,k,n}} and \eqref{eqn-mse-1.2} relaxes the transmitted rate \me{\mvec{t}{l,k,n}} using the the \ac{MSE} relation.
...
\text{minimize} &\quad& \|  \tilde{\mbf{v}}  \|_q \IEEEyessubnumber \label{eqn-mse-2.1} \\

...
The decentralization is achieved by decomposing the original convex problem in \eqref{eqn-decent-1} by a parallel iterative subproblems using either primal or \acl{DD} method. The coupling variables are updated in each iteration by exchanging limited information among the subproblems. Now, to decouple the problem in \eqref{eqn-decent-1}, the coupling variable \me{\zeta_{l,k,n,b}} in \eqref{eqn-decent-3}, which bind all \acp{BS} in \me{\mc{B}}, is replaced by a \ac{BS} specific variable \me{\zeta_{l,k,n,b}^{\{b_k\}}}. Using the \ac{BS} specific variable \me{\zeta_{l,k,n,b}^{\{b_k\}}} in \eqref{eqn-decent-3}, the subproblem in \eqref{eqn-decent-1} decouples completely for each \ac{BS} to find the precoders for the associated users by exchanging limited information to update \me{\zeta_{l,k,n,b}^{\{b_k\}}} in each iteration for the \ac{BS} \me{b_k}.

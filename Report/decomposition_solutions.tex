...
Following the similar approach as that in \cite{pennanen2011decentralized,tolli2011decentralized}, the coupling constraint in \eqref{eqn-9.1c} or \eqref{eqn-mse-1.3} can be expressed by grouping the interference contribution from each \ac{BS} in the coordinating set \me{\mathcal{B}} as

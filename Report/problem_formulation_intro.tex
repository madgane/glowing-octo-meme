...
To minimize the total number of backlogged packets, we consider minimizing \me{\ell_{q}}-norm of all the queue deviation given by
\begin{equation}
v_k =  Q_k - t_k = Q_k - \sum_{n = 1}^N \sum_{l = 1}^{L} \log_2(1+\gamma_{l,k,n}).
\label{eqn-4.2}
\end{equation}
Explicitly, the considered problem is given by \me{\sum_{k \in \mc{U}} \, | v_k |^q}. With this objective, the problem of weighted queued packet minimization is given by

...
\label{fig-d-1}
\caption{\me{\chi} at \ac{SCA} points for \me{\lbrace N,N_B,K,N_R \rbrace = \lbrace 3,2,8,1 \rbrace}.}
\label{fig-d} \vspace{-0.15in}
\end{figure}
}
...
\begin{figure}
	...
	\caption{\me{\chi} at \ac{SCA} points for \me{\lbrace N,N_B,K,N_R \rbrace = \lbrace 5,2,8,1 \rbrace}.}

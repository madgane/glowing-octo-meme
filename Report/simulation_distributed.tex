...
\begin{figure}
	...
	\caption{Convergence behaviour of the centralized and the distributed algorithms for a system \me{\lbrace N,N_B,K,N_R \rbrace = \lbrace 3,2,8,1 \rbrace} \review{using \me{\ell_1} norm}}
	\label{fig-d}
\end{figure}

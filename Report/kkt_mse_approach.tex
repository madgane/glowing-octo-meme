...
\item when the number of backlogged packets of each user is large enough \me{Q_k \gg \sum_{n=1}^N \sum_{l=1}^L {t}_{l,k,n}} to ignore the absolute operator and the queues as well.
\end{itemize}

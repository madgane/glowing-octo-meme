...
The problem in \eqref{kkt-mse-1} is solved using the \ac{KKT} expressions, which is obtained by taking the derivative of the Lagrangian function w.r.t the primal and the dual variables, complementary slackness conditions, and the primal, dual feasibility requirements as shown in Appendix \ref{a-1}. Upon solving, we obtain the iterative solution as

...
\usepackage{subeqnarray,multirow,cite,array,setspace,fixltx2e,lineno,verbatim,todonotes,inputenc,mathtools}
...
\subsection{Convergence Analysis} \label{sec-3.5}

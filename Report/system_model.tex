...
\end{equation}
where \me{t_{l,k,n}} denotes the number of transmitted packets or bits over the \me{\ith{l}} spatial stream on the \me{\ith{n}} sub-channel. The maximum rate achieved over the space-frequency resource \me{(l,n)} is given by \me{t_{l,k,n} \leq \log_2(1 + \gamma_{l,k,n})} for the \ac{SINR} \me{\gamma_{l,k,n}}.\footnote{The upper bound can be achieved by using Gaussian signaling.} Note that \me{t_k} and \me{Q_k} are represented by the same units, \textit{i.e.}, in bits defined per channel use. 
...
\begin{algorithm}
 ...
 \Repeat{convergence or \me{i \geq I_{\max}}}{
	...
	downlink transmission from all \acp{BS} to notify the precoders to update \me{\mvec{W}{k,n}} from users\;
    updated \me{\mvec{W}{k,n}} is notified to all \acp{BS} in \me{\mc{B}} using uplink precoded pilots as in \cite{komulainen2013effective}\;
    update \me{\tilde{\mbfa{u}}_{l,k,n}} using \eqref{eqn-wsrm-expr} and \eqref{eqn-6.3} for the \ac{SCA} approach (or)\;
    update \me{\tilde{\epsilon}_{l,k,n}} using \eqref{eqn-mse-2.3} with equality for the \ac{MSE} approach \;
    $i = i + 1$ \;
  }
 }

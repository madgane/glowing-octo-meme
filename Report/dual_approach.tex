...
\end{equation}
where the step size parameter \me{\rho} is chosen in accordance with \cite{boyd2011distributed}. The above iteration is performed until convergence or for certain accuracy in the variation of the objective value between two consecutive updates. The distributed precoder design using \ac{ADMM} approach is shown in Algorithm \ref{algo-3}.
{\allowdisplaybreaks 
\begin{algorithm}
	\SetAlgoLined
	\DontPrintSemicolon

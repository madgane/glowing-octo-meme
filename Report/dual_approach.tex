...
We consider the \ac{ADMM} approach to decentralize the convex problem \eqref{eqn-decent-1} over \acl{DD} due to its better convergence properties \cite{boyd2011distributed}. Similar work has been carried to decouple the minimum power precoder design in \cite{admm_robust}

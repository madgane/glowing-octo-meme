...
& \quad & \sum_{n=1}^N \sum_{l = 1}^L \log_2(1 + \gamma_{l,k,n}) \leq Q_k, \fall k \in \mc{U} \IEEEyessubnumber \label{eqn-3.1.4}
\end{IEEEeqnarray}
...
\text{subject to.} & \quad & \eqref{eqn-3.1.1}, \eqref{eqn-3.1.3} \; \text{and} \; \eqref{eqn-3.1.4} \IEEEyessubnumber
\end{IEEEeqnarray}

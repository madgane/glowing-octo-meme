...
The optimal transmission rate vector \me{\mbf{t}} to minimize the total number of backlogged packets in the system is obtained by minimizing the Lyapunov function drift expressed as

...
To minimize the total number of backlogged packets for time instant \me{i}, the optimal transmission rate of all users are obtained by minimizing the Lyapunov drift expressed as  

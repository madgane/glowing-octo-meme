...
\begin{figure*}
\centering
\subfloat[][\me{N_T = 4, N_R = 1} system]{
\includegraphics[width=0.48\textwidth]{fig-1-1}
\label{fig-1}}
\hfill
\subfloat[][\me{N_T = 4, N_R = 2} system]{
\includegraphics[width=0.48\textwidth]{fig-2-1}
\label{fig-2}}
\caption{Number of backlogged packets at \ac{SCA} updates for \me{\lbrace N,N_B,K \rbrace = \lbrace 3,3,9 \rbrace} System}
\label{fig-a}
\end{figure*}

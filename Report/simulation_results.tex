...
\begin{figure}
	...
	\caption{Convergence of the centralized and the distributed algorithms for \me{\lbrace N,N_B,K,N_T,N_R \rbrace = \lbrace 3,2,8,4,1 \rbrace} \review{using \me{\ell_1} norm for \ac{JSFRA} schemes}}
	\label{fig-d}
\end{figure}

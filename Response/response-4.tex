...
\resp \review{
	\begin{enumerate}
		...
		\end{equation}
		where \me{\mbf{x}} denotes the stacked vector of optimization variables and \me{\mbf{x}^{(i)}} denotes the value of \me{\mbf{x}} in the \me{\ith{i}} iteration. It has been discussed in the Appendix B-C. It makes the objective strictly convex, therefore, the resulting subproblem has a unique minimizer.
	\end{enumerate}
		}

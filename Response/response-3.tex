...
\resp \review{
	\begin{itemize}
		\item We agree that the MSE equivalence with the SINR expression is valid only when the receiver is based on MMSE objective. In our MSE reformulation solution, we have used the MMSE receiver irrespective of the \me{\ell_q} norm used in the objective. 

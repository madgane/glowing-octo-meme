...
\resp \review{We thank the reviewer for the comment. Rigorous convergence proof for the proposed algorithm is provided in Appendix B on the supplementary document. The uniqueness is also justified implicitly by the linear approximation performed on the DC constraint (16b), which makes the transmit precoders to be susceptible to the phase rotation. The discussion on the uniqueness is provided in Appendix B-C.}

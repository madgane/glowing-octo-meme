...
\end{equation}
Note that \eqn{\tilde{\mbf{m}}_{j}^{(i)}} is the operating point for the \eqn{\ith{(j+1)}} \ac{SCA} iteration in the \eqn{\ith{i}} \ac{AO} step and \eqn{\mbf{m}_{j}^{(i)}} is the solution obtained by solving (20) in the \eqn{\ith{j}} \ac{SCA} iteration.

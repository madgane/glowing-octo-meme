...
\vspace{0.5in}
The authors are grateful to the associate editor for being considerate enough to provide us with this additional opportunity to revise and correct our convergence proof. We thank all the reviewers for their valuable comments on the manuscript, which have been greatly helpful to improve the paper quality. Based on the comments, we have revised our manuscript to ensure that all the reviewers comments are addressed properly and the technical correctness of the convergence proof is also verified. 
\input{additions}

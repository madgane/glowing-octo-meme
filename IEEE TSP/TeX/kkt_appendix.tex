...
To design transmit precoders iteratively, we solve the \ac{KKT} conditions of problem \eqref{kkt-mse-1} by assuming the constraints \eqref{kkt-mse-1.2} and \eqref{kkt-mse-1.3} are tight. Hence, we obtain the following equations.
...
\nabla_{\mvec{w}{l,k,n}} : & \sum_{(x,y) \neq (l,k)} \mvec{H}{b_y,k,n} \mvec{m}{x,y,n} \mvec{m}{x,y,n}^\herm \mvec{H}{b_y,k,n}^\herm \mvec{w}{l,k,n}  + N_0 \mathbf{I}_{N_R} \mvec{w}{l,k,n} &= \mvec{H}{b_k,k,n} \; \mvec{m}{l,k,n}. \IEEEyessubnumber \label{kkt-mse-2.4}
\end{IEEEeqnarray}
}{\allowdisplaybreaks
